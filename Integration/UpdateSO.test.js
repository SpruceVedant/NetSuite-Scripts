 ...
 */
define(['N/record', 'N/https', 'N/log', 'N/file'], function(record, https, log, file) {
    ...
    function createSalesforceOrder(salesOrderRecord, sfAccountId, itemMappings, config) {
        var orderData = {
            ...
            "NetSuite_Order_Number__c": salesOrderRecord.getValue('tranid'),
            "NetSuite_Order_Status__c": salesOrderRecord.getValue('orderstatus'),
            "Total_NetSuite__c": salesOrderRecord.getValue('total'),
            "Tax_Total_NetSuite__c": salesOrderRecord.getValue('taxtotal')
        };
