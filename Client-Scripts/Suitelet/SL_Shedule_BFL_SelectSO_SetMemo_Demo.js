    ...
    (currentRecord, serverWidget, url, http, task, search) => {
        ...
        function onRequest(scriptContext) {
            if (scriptContext.request.method === 'GET') {
                ...
                const sales_order_arr = scriptContext.request.parameters.custpage_arr;

                var form = serverWidget.createForm({
                    title: 'Sales Order'
                });
                form.clientScriptFileId = 8801;
                ...
                if (sales_order_arr) {
                    log.debug('sales_order_arr', sales_order_arr)
